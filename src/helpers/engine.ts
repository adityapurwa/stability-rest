/**
 * List of well-known engine. This might be outdated, to get the latest available engine, use EngineResource.list().
 */
export enum WellKnownEngine {
  ...
  "stable-inpainting-512-v2-0" = "stable-inpainting-512-v2-0",
}
